...
/**
 * POST /api/approvals/[actionId]/approve - Approve an action
 */
export async function POST(
  ...
  try {
    ...
    // Try Gateway first
    try {
      const gatewayResponse = await fetch(`${GATEWAY_URL}/api/approvals/${actionId}/approve`, {
        method: 'POST',
    ...
    try {
      ...
      approval.approvedBy = reason || 'dashboard-user';
